...
from media_types import FALLBACK_FORMAT, image_format
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            out = (
                ...
                image_format(info.get("mime"), url),
            )
...
def manifest(*, title, manifest_uri, image_filepath, summary="", metadata=None, attribution=""):
    ...
    """
    full_url, w, h, body_format = image_info(image_filepath)
                        ...
                        "items": [
                            {
                                ...
                                "body": {
                                    "id": full_url,
                                    "type": "Image",
                                    "format": body_format or FALLBACK_FORMAT,
                                    "height": h,
                                    "width": w,
                                },
                                "target": canvas,
